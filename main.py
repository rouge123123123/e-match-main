...
def Splashs():
    splash = pygame.image.load('splashscreen.png')
    splash = pygame.transform.scale(splash, (1000,600))
...
def Mainmenu():
    mainmenu = pygame.image.load('mainscreen.png')
...
#def tutorial
    #def tutorial():
       ...
       # tutorial = pygame.transform.scale(tutorial, (1000, 600))
